...
/*
 * 5x8 column-major font, LSB = top pixel of the 8-pixel-tall column.
 * Index 0 corresponds to ASCII 0x20 (space).
 * Matches SSD1306 page-addressing byte layout directly.
 */
static const u8 ssd1306_font5x8[][FONT_WIDTH] = {
